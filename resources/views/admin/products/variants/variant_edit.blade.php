        ...
        <div class="col-lg-8">
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <p class="mb-0 text-muted">Produk: {{ $product->name }} | Variant: {{ $variant->getVariantName() }}</p>
                </div>
                <div class="card-body">
                    <!-- Form action -->
                    <form action="{{ route('admin.product.variants.update', [$product, $variant]) }}" method="POST">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('stock') is-invalid @enderror" 
                                           id="stock" name="stock" value="{{ old('stock', $variant->stock) }}" 
                                           placeholder="0" min="0" required>
                                    @error('stock')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
                            <strong>Info:</strong> Kombinasi ukuran dan warna harus unik untuk setiap variant
                        </div>
